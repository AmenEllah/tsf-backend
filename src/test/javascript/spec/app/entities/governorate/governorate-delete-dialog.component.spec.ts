...
import { GovernorateDeleteDialogComponent } from 'app/entities/governorate/governorate-delete-dialog.component';
  ...
  describe('Governorate Management Delete Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [GovernorateDeleteDialogComponent],
      })
