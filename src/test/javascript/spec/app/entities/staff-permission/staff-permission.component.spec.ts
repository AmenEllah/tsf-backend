...
import { StaffPermissionComponent } from 'app/entities/staff-permission/staff-permission.component';
...
describe('Component Tests', () => {
  describe('StaffPermission Management Component', () => {
    let comp: StaffPermissionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(StaffPermissionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.staffPermissions && comp.staffPermissions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
