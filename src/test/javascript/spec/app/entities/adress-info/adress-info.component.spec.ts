...
import { AdressInfoComponent } from 'app/entities/adress-info/adress-info.component';
...
describe('Component Tests', () => {
  describe('AdressInfo Management Component', () => {
    let comp: AdressInfoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AdressInfoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.adressInfos && comp.adressInfos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
