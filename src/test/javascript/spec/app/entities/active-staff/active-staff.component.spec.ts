...
import { ActiveStaffComponent } from 'app/entities/active-staff/active-staff.component';
...
describe('Component Tests', () => {
  describe('ActiveStaff Management Component', () => {
    let comp: ActiveStaffComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ActiveStaffComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.activeStaffs && comp.activeStaffs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
