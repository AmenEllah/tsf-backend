 ...
 * element interface generated in the com.soprabanking.amplitude package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _ErrorResponseFlow_QNAME = new QName(
			"http://soprabanking.com/amplitude", "errorResponseFlow");
	private final static QName _CreateCustomerRequestFlow_QNAME = new QName(
			"http://soprabanking.com/amplitude", "createCustomerRequestFlow");
	private final static QName _GetStatusResponseFlow_QNAME = new QName(
			"http://soprabanking.com/amplitude", "getStatusResponseFlow");
	private final static QName _GetStatusRequestFlow_QNAME = new QName(
			"http://soprabanking.com/amplitude", "getStatusRequestFlow");
	private final static QName _CreateCustomerResponseFlow_QNAME = new QName(
			"http://soprabanking.com/amplitude", "createCustomerResponseFlow");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package: com.soprabanking.amplitude
	 *
	 */
	 ...
	 * {@link ErrorResponseFlow }{@code >}
	 *
	 */
	@XmlElementDecl(namespace = "http://soprabanking.com/amplitude", name = "errorResponseFlow")
	public JAXBElement<ErrorResponseFlow> createErrorResponseFlow(
			ErrorResponseFlow value) {
		return new JAXBElement<ErrorResponseFlow>(_ErrorResponseFlow_QNAME,
				ErrorResponseFlow.class, null, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link CreateCustomerRequestFlow }{@code >}
	 *
	 */
	@XmlElementDecl(namespace = "http://soprabanking.com/amplitude", name = "createCustomerRequestFlow")
	public JAXBElement<CreateCustomerRequestFlow> createCreateCustomerRequestFlow(
			CreateCustomerRequestFlow value) {
		return new JAXBElement<CreateCustomerRequestFlow>(
				_CreateCustomerRequestFlow_QNAME,
				CreateCustomerRequestFlow.class, null, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link GetStatusResponseFlow }{@code >}
	 *
	 */
	@XmlElementDecl(namespace = "http://soprabanking.com/amplitude", name = "getStatusResponseFlow")
	public JAXBElement<GetStatusResponseFlow> createGetStatusResponseFlow(
			GetStatusResponseFlow value) {
		return new JAXBElement<GetStatusResponseFlow>(
				_GetStatusResponseFlow_QNAME, GetStatusResponseFlow.class,
				null, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link GetStatusRequestFlow }{@code >}
	 *
	 */
	@XmlElementDecl(namespace = "http://soprabanking.com/amplitude", name = "getStatusRequestFlow")
	public JAXBElement<GetStatusRequestFlow> createGetStatusRequestFlow(
			GetStatusRequestFlow value) {
		return new JAXBElement<GetStatusRequestFlow>(
				_GetStatusRequestFlow_QNAME, GetStatusRequestFlow.class, null,
				value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link CreateCustomerResponseFlow }{@code >}
	 *
	 */
	@XmlElementDecl(namespace = "http://soprabanking.com/amplitude", name = "createCustomerResponseFlow")
	public JAXBElement<CreateCustomerResponseFlow> createCreateCustomerResponseFlow(
			CreateCustomerResponseFlow value) {
		return new JAXBElement<CreateCustomerResponseFlow>(
				_CreateCustomerResponseFlow_QNAME,
				CreateCustomerResponseFlow.class, null, value);
	}
