...
import com.attijari.web.rest.ActiveStaffResource;
...
/**
 * Criteria class for the {@link ActiveStaff} entity. This class is used
 * in {@link ActiveStaffResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /active-staffs?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ActiveStaffCriteria implements Serializable, Criteria {
    ...
    public ActiveStaffCriteria() {
    }

    public ActiveStaffCriteria(ActiveStaffCriteria other) {
    ...
    @Override
    public ActiveStaffCriteria copy() {
        return new ActiveStaffCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ActiveStaffCriteria that = (ActiveStaffCriteria) o;
        return
