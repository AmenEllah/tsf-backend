...
import com.attijari.service.MailService;
import com.attijari.service.UserService;
import com.attijari.service.dto.PasswordChangeDTO;
import com.attijari.service.dto.UserDTO;
import com.attijari.web.rest.errors.EmailAlreadyUsedException;
import com.attijari.web.rest.errors.InvalidPasswordException;
import com.attijari.web.rest.errors.LoginAlreadyUsedException;

import com.attijari.web.rest.vm.KeyAndPasswordVM;
import com.attijari.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public AccountResource(UserRepository userRepository, UserService userService, MailService mailService, AppMailingService appMailingService) {
    ...
    public void registerAccount(@Valid @RequestBody UserDTO userDTO) {
        ...
        appMailingService.sendVerificationCode(user, "Code d'accès", verificationCode);
    }
