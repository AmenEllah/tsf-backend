...
export class GovernorateComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.governorateService
      ...
      .subscribe(
        (res: HttpResponse<IGovernorate[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInGovernorates(): void {
    this.eventSubscriber = this.eventManager.subscribe('governorateListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IGovernorate[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
