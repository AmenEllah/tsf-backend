...
export class NationalityComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.nationalityService
      ...
      .subscribe(
        (res: HttpResponse<INationality[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInNationalities(): void {
    this.eventSubscriber = this.eventManager.subscribe('nationalityListModification', () => this.loadPage());
  }
