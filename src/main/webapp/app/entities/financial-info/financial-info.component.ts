...
export class FinancialInfoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.financialInfoService
      ...
      .subscribe(
        (res: HttpResponse<IFinancialInfo[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInFinancialInfos(): void {
    this.eventSubscriber = this.eventManager.subscribe('financialInfoListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IFinancialInfo[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
