...
export class ReqDocUploadComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.reqDocUploadService
      ...
      .subscribe(
        (res: HttpResponse<IReqDocUpload[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInReqDocUploads(): void {
    this.eventSubscriber = this.eventManager.subscribe('reqDocUploadListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IReqDocUpload[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/req-doc-upload'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
