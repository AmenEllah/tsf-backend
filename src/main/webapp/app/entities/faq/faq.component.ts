...
export class FAQComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.fAQService
      ...
      .subscribe(
        (res: HttpResponse<IFAQ[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInFAQS(): void {
    this.eventSubscriber = this.eventManager.subscribe('fAQListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IFAQ[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
