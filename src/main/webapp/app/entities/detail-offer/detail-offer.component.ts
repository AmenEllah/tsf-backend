...
export class DetailOfferComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.detailOfferService
      ...
      .subscribe(
        (res: HttpResponse<IDetailOffer[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInDetailOffers(): void {
    this.eventSubscriber = this.eventManager.subscribe('detailOfferListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IDetailOffer[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
